...
const Reconocimiento = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route('gemini_ejemplo_6_google_gemini_php_imagen_post'), {
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
                setData('pregunta', 'url');
            },
            onError: (errors) => {
                ...
                <div className="col-12">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Reconocimiento de imágenes</li>
                        </ol>
                    </nav> 

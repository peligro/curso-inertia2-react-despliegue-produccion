...
Route::get('/formularios', [FormulariosController::class, 'formularios_index'])->name('formularios_index');
Route::get('/formularios/post', [FormulariosController::class, 'formularios_post'])->name('formularios_post');
Route::post('/formularios/post', [FormulariosController::class, 'formularios_post_post'])->name('formularios_post_post');
...
Route::middleware([Acceso::class])->group(function () {
    ...
    Route::get('/usuarios/delete/{id}', [UsuariosController::class, 'usuarios_delete'])->name('usuarios_delete');
    ...
    Route::get('/openai/chatbot-api', [OpenaiController::class, 'openai_chatbot_api'])->name('openai_chatbot_api');
    Route::post('/openai/chatbot-api', [OpenaiController::class, 'openai_chatbot_api_post'])->name('openai_chatbot_api_post');
    Route::get('/openai/consulta-simple', [OpenaiController::class, 'openai_consulta_simple'])->name('openai_consulta_simple');
    Route::get('/openai/cliente-oficial1', [OpenaiController::class, 'openai_cliente_oficial_1'])->name('openai_cliente_oficial_1');
    Route::get('/openai/cliente-oficial2', [OpenaiController::class, 'openai_cliente_oficial_2'])->name('openai_cliente_oficial_2');
    Route::post('/openai/cliente-oficial2', [OpenaiController::class, 'openai_cliente_oficial_2_post'])->name('openai_cliente_oficial_2_post');
    Route::get('/openai/cliente-oficial3', [OpenaiController::class, 'openai_cliente_oficial_3'])->name('openai_cliente_oficial_3');
    Route::post('/openai/cliente-oficial3', [OpenaiController::class, 'openai_cliente_oficial_3_post'])->name('openai_cliente_oficial_3_post');
    Route::get('/openai/cliente-oficial4', [OpenaiController::class, 'openai_cliente_oficial_4'])->name('openai_cliente_oficial_4');
    Route::post('/openai/cliente-oficial4', [OpenaiController::class, 'openai_cliente_oficial_4_post'])->name('openai_cliente_oficial_4_post');
    Route::post('/openai/cliente-oficial4-save', [OpenaiController::class, 'openai_cliente_oficial_4_post_save'])->name('openai_cliente_oficial_4_post_save');

    Route::get('/deeseek', [DeepSeekController::class, 'deepseek_index'])->name('deepseek_index');
    Route::get('/deeseek/api', [DeepSeekController::class, 'deepseek_api'])->name('deepseek_api');
    Route::get('/deeseek/chatbot', [DeepSeekController::class, 'deepseek_chatbot'])->name('deepseek_chatbot');
    Route::post('/deeseek/chatbot', [DeepSeekController::class, 'deepseek_chatbot_post'])->name('deepseek_chatbot_post');
    Route::get('/deeseek/consulta-simple', [DeepSeekController::class, 'deepseek_consulta_simple'])->name('deepseek_consulta_simple');
    ...
    Route::get('/gemini/ejemplo-2', [GeminiController::class, 'gemini_ejemplo_2'])->name('gemini_ejemplo_2');
    Route::post('/gemini/ejemplo-2', [GeminiController::class, 'gemini_ejemplo_2_post'])->name('gemini_ejemplo_2_post');
    Route::get('/gemini/ejemplo-3', [GeminiController::class, 'gemini_ejemplo_3'])->name('gemini_ejemplo_3');
    Route::get('/gemini/ejemplo-4', [GeminiController::class, 'gemini_ejemplo_4'])->name('gemini_ejemplo_4');
    Route::get('/gemini/ejemplo-5', [GeminiController::class, 'gemini_ejemplo_5'])->name('gemini_ejemplo_5');
    Route::post('/gemini/ejemplo-5', [GeminiController::class, 'gemini_ejemplo_5_post'])->name('gemini_ejemplo_5_post');
    Route::get('/gemini/ejemplo-6', [GeminiController::class, 'gemini_ejemplo_6'])->name('gemini_ejemplo_6');
    Route::post('/gemini/ejemplo-6', [GeminiController::class, 'gemini_ejemplo_6_post'])->name('gemini_ejemplo_6_post');
...
Route::get('/health', function(){
    return response()->json(
        [
            'status'=>'success',
            'message' => 'Aplicación está corriendo',

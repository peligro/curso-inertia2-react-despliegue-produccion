...
import { PerfilesInterface, PerfilesProps } from "resources/js/Interfaces/PerfilesInterfaces";


const Home = () => {
  const {datos, flash} = usePage<PerfilesProps>().props;
      ...
      <div className="col-12">
        ...
        <div className="table-responsive">
          <table className="table table-bordered table-hover table-striped">
            ...
            <tbody>
              {datos.map((dato:PerfilesInterface)=>(
                <tr key={dato.id}>
                  <td>{dato.id}</td>
                  <td>{dato.nombre}</td>

...
const Reconocimiento = () => {
   ...
   const {data, setData, post, processing} = useForm({
    ...
    {
      e.preventDefault();
      post(route('gemini_ejemplo_6_post'), {
        preserveScroll: true,
        preserveState: true,
        onSuccess:()=>{
          setData('pregunta', '');
        ...
        <div className="col-12">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Reconocimiento de imágenes Google Gemini PHP</li>
            </ol>
          </nav> 
          <h1>Reconocimiento de imágenes Google Gemini PHP</h1>
                  ...
                  <Form onSubmit={handleSubmit}>
                    <div className="row">
                      ...
                      <div className="mb-3">
                        ...
                        placeholder="https://dummyimage.com/450x300/dee2e6/6c757d.jpg"
                        disabled={processing} />
                        {errors?.url && (

        ...
        <div className="col-12">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Google Gemini PHP</li>
            </ol>
          </nav> 
          <h1>Google Gemini PHP</h1>
          <p>https://github.com/google-gemini-php/laravel</p>
...
export default GoogleGeminiPHP